...
// ==========================================
// 3. UPDATE PRICING CONFIG (Admin Only)
// ==========================================
router.put(
  "/",
  verifyAuth,
  ...
  async (req, res) => {
    try {
      ...
      // Basic validation to ensure the body isn't completely empty
      if (!newConfigData || Object.keys(newConfigData).length === 0) {
